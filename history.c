...
/**
 * write_history - create a file/append to an existing file
...
/**
 * read_history - from file it reads history
 * @info:parameter strut
 * Return: histcunt on success, 0 on fail
 */
